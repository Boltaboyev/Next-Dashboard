...
const Header = () => {
    return (
        <header>
            <nav className=" border-gray-200 px-4 lg:px-6 py-2.5 bg-zinc-900">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="flex items-center lg:order-2">
                        <Link
                            href={"/sign-in"}
                            className="text-white bg-gray-700 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 outline-none active:scale-[.98] select-none cursor-pointer">
                            Log in
                        </Link>
